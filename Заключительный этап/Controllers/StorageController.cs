...
namespace KnOwl.Controllers
{
    ...
    public class StorageController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPrivateArticles()
        {
            ...
            var response = _articleService.Get(author);
        ...
        public async Task<IActionResult> SearchArticle([FromBody] ArticleRequest request)
        {
            request.Article.Author = await _userService.Get(HttpContext.GetUserName());
            var response = await _articleService.Get(request);
